...
use Buckaroo\Models\Adapters\ServiceParametersKeys\CreditClickCustomerAdapter;
...
class CreditClick extends PaymentMethod
{
    ...
    public function setPayServiceList(array $serviceParameters = [])
    {
        ...
        $parametersService = new CustomerParameters(new DefaultParameters($serviceList), ['customer' => new CreditClickCustomerAdapter((new Person())->setProperties($serviceParameters['customer'] ?? []))]);
