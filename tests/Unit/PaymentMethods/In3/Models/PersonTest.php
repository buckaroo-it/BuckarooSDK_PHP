...
use Buckaroo\PaymentMethods\In3\Models\Person;
use Tests\TestCase;
...
class PersonTest extends TestCase
{
     ...
     */
    public function it_handles_various_languages(string $language): void
    {
        $person = new Person(['conversationLanguage' => $language]);

        $this->assertSame($language, $person->conversationLanguage);
    }
