...
namespace Tests\Unit\PaymentMethods\GooglePay\Models;
...
class PayTest extends TestCase
{
    ...
    {
        $pay = new Pay(['paymentData' => 'GOOGLE_PAYMENT_DATA']);

        $this->assertSame('GOOGLE_PAYMENT_DATA', $pay->paymentData);
    }
    ...
    {
        $pay = new Pay([
            'paymentData' => 'GPay_DATA_789',
            'customerCardName' => 'Jane Smith',
        ]);

        $this->assertSame('GPay_DATA_789', $pay->paymentData);
    ...
    public function it_converts_to_array(): void
    {
        ...
        $this->assertSame('DATA_TEST', $array['paymentData']);
